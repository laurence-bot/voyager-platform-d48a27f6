...
export const namibieDetailed: DetailedPays = {
  ...
  practical: {
    visa: "Depuis le 1er avril 2025, un visa est obligatoire pour les ressortissants français effectuant un court séjour en Namibie. Il peut être demandé en ligne sur le portail officiel namibien (rubrique « visa on arrival ») ou délivré à l'arrivée aux points d'entrée habilités, notamment les aéroports de Windhoek et de Walvis Bay. Le passeport doit être valide au moins 6 mois après la fin du séjour et comporter au moins 3 pages vierges. Informations vérifiées le 20 septembre 2026 — toujours consulter France Diplomatie et les autorités namibiennes avant le départ.",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Oui. Depuis le 1er avril 2025, les ressortissants français ont besoin d'un visa pour un court séjour en Namibie. Il peut être demandé en ligne sur le portail officiel namibien, dans la rubrique « visa on arrival », ou obtenu à l'arrivée à un point d'entrée habilité. Le passeport doit être valide au moins 6 mois après la fin du séjour et comporter au moins 3 pages vierges. Informations vérifiées le 20 septembre 2026 — toujours consulter France Diplomatie et les autorités namibiennes avant le départ.",
    },
    {
